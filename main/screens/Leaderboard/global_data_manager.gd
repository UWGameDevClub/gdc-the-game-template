...
signal global_leaderboards_updated(daily_lb : Array[ScoreResource], alltime_lb : Array[ScoreResource])
...
func get_scores():
	...
	global_leaderboards_updated.emit(daily_list, alltime_list)
